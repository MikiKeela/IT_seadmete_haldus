...
def run() -> None:
    """
    Käivitab käsurea menüü ja haldab kasutaja tegevusi.
    """
...
def _print_menu() -> None:
    """
    Kuvab kasutajale põhimenüü valikud.
    """
    print("\n=== IT seadmete haldus ===")
    print("1) Lisa seade")
...
def _ask_non_empty(prompt_text: str) -> str:
    """
    Küsib kasutajalt sisendi ja tagastab selle, kui see ei ole tühi.

    :param prompt_text: Küsimuse tekst
    :return: Kasutaja sisend
    """
    while True:
...
def _ask_status() -> str:
    """
    Küsib kasutajalt seadme staatuse ja kontrollib, et see oleks lubatud.
...
def _ask_format() -> str:
    """
    Küsib kasutajalt salvestus-/laadimisformaadi valiku.
...
def _list_devices(manager: DeviceManager) -> None:
    """
    Kuvab kõik seadmed nummerdatult.

    :param manager: DeviceManager objekt
    """
...
def _add_device_flow(manager: DeviceManager) -> None:
    """
    Käsitleb seadme lisamise töövoogu.
...
def _update_status_flow(manager: DeviceManager) -> None:
    """
    Käsitleb seadme seisundi muutmise töövoogu.
...
def _save_flow(manager: DeviceManager) -> None:
    """
    Käsitleb salvestamise töövoogu (CSV või JSON).
...
def _load_flow(manager: DeviceManager) -> None:
    """
    Käsitleb laadimise töövoogu (CSV või JSON).
